    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listViewTools.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                //--- выводим тост с номером позиции. getApplicationContext() - Вместо this получае контекст приложения, т.к. мы сейчас находимся не в активности, а в новом классе OnItemClickListener()
